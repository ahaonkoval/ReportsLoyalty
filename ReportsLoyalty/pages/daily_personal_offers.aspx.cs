...
namespace ReportsLoyalty.pages.personal_offers
{
    public partial class personal_offers : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ReportViewerPersonalOffers.LocalReport.SetParameters(new ReportParameter("NameCampaign", 
            ...
            ReportViewerPersonalOffers.LocalReport.SetParameters(new ReportParameter("DepartName",
