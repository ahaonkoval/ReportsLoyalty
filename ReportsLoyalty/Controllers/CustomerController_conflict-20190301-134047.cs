...
namespace ReportsLoyalty.Controllers
{
    public class CustomerController : ApiController
    {
        ...
        public MemoryStream GenerateExcelReportBetween(int campaignId, int part_start, int part_end)
        {
            using (GetData gd = new GetData())
            {
                ...
                System.Data.DataTable dt = gd.Customers.GetCustomersBetween(campaignId, part_start, part_end);
